	...
	internal static class GenerateBrushToolGUI
	{
		...
		static void OnGUIContents(GenerateBrushTool tool, bool isSceneGUI)
		{
			...
			if (!isSceneGUI)
			{
				...
				tool.BuilderMode = (ShapeMode)GUIStyleUtility.ToolbarWrapped((int)tool.BuilderMode, ref shapeModeRects, out shapeModeBounds, csg_skin.shapeModeNames, tooltips: GUIStyleUtility.shapeModeTooltips, yOffset: 20, areaWidth: EditorGUIUtility.currentViewWidth - 4);
