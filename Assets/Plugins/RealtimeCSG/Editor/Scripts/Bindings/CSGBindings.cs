...
namespace RealtimeCSG
{
	...
	internal static class CSGBindings
	{
		...
		private static extern bool RayCastIntoModelMultiGet(int					objectCount,			
															...
															int					triangleVerexCount,
															[MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0), Out] Vector3[]	triangleVertices);
												  ...
												  out BrushIntersection[]	intersections)
        {
			...
			Vector3[]		triangleVertices = new Vector3[intersectionCount * 3];
//			IntersectionOutput[]	intersectionOutput = new IntersectionOutput[intersectionCount];
			...
			for (int i = 0, t = 0; i < intersectionCount; i++, t+=3)
			{
				...
				result.model				= model;
				result.triangle				= new Vector3[] {
					triangleVertices[t+0],
					triangleVertices[t+1],
					triangleVertices[t+2]
				};
        ...
        private static extern bool TryUpdatingModelMeshes(Int32				modelID,
													   ...
													   UInt32				meshRequestCount,
													   [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3), Out] Int32[] meshRequests*/); 
		...
		private static extern bool GetBrushOutlineValues(Int32		brushID,
														 ...
														 [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 9), Out] Int32[]	invisibleInnerLines,
														 Int32		invalidLineCount,
														 [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 11), Out] Int32[]	invalidLines);
        ...
        public static void RegisterExternalMethods()
		{
			...
			methods.SetBrush					= delegate (Int32 brushID,
													...
													Int32 cutNodeCount, CutNode[] cutNodes,
													Int32 surfaceCount, Surface[] surfaces,
													Int32 texGenCount, TexGen[] texgens, TexGenFlags[] texgenFlags) 
													{ Debug.Log("SetBrush"); return SetBrush(brushID,
																					...
																					ref translation,
																					cutNodeCount, cutNodes,
																					surfaceCount, surfaces,
																					texGenCount, texgens, texgenFlags); };
