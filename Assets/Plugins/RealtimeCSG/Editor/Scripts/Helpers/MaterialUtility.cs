...
namespace RealtimeCSG
{
	public static class MaterialUtility
	{
		...
		internal const string DiscardedMaterialName     = TransparentSpecialSurfaceShader + "_" + DiscardedName;
		internal const string InvisibleMaterialName		= TransparentSpecialSurfaceShader + "_" + InvisibleName;
		...
		internal static Material DiscardedMaterial	{ get { if (!_discardedMaterial) _discardedMaterial = GenerateEditorMaterial(TransparentSpecialSurfaceShader, DiscardedName, DiscardedMaterialName); return _discardedMaterial; } }

		private static Material _invisibleMaterial;
		internal static Material InvisibleMaterial	{ get { if (!_invisibleMaterial) _invisibleMaterial = GenerateEditorMaterial(TransparentSpecialSurfaceShader, InvisibleName, InvisibleMaterialName); return _invisibleMaterial; } }
